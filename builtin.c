...
/**
 * get_builtin - validates a command with a corresponding
 ...
 * @args: arr of arguments containing the exit value.
...
/**
 * shellby_cd - make changes the current directory of the shellby process.
